...
export const en = {
  ...
  "selection.fileUnit.many": "{{count}} files",
  "selection.folderUnit.one": "1 folder",
  "selection.folderUnit.many": "{{count}} folders",
  ...
  "selection.foldersSelected": "{{count}} folders selected",
  "selection.breakdownSelected": "{{files}}, {{folders}} selected",
  "selection.copyPaths": "Copy paths",
  "selection.copyPath.copied": "Path copied to clipboard",
  "selection.copyPaths.copied": "Paths copied to clipboard",
  "selection.copyPath.copyFailed": "Could not copy path",
  ...
  "preview.label": "Get Info",
  "preview.selectFile": "Select an item to view its metadata.",
  "preview.errorTitle": "Can't open this item",
  "preview.loading": "Loading…",
  "preview.textTruncated": "Preview truncated — file exceeds display limit.",
  "preview.textLoadError": "Couldn't load file contents for preview.",
  "preview.textTooLarge": "File is too large to preview.",
  "preview.path": "Path",
  "preview.type": "Type",
  ...
  "preview.getInfo.titleSingle": "Info of {{name}}",
  "preview.getInfo.titleMultiple": "Info of {{count}} items",
  ...
  "preview.aggregate.symlinks": "{{count}} symlinks",
  ...
  "settings.slideshow.startAtActiveItem.description":
    "Open multi-file preview on the focused item instead of the first selected file.",
  ...
  "actions.navigation.back.name": "Back",
  "actions.navigation.forward.name": "Forward",
  "actions.navigation.refresh.name": "Refresh",
  "actions.navigation.cancelLoad.name": "Cancel Loading",
  "actions.navigation.focusQuickFilter.name": "Focus Quick Filter",
  "actions.navigation.focusQuickFilter.description": "Focus the file name filter field",
  "actions.appearance.category": "Appearance",
  "actions.appearance.cycleTheme.name": "Cycle Color Theme",
  "actions.appearance.cycleTheme.description":
    "Switch between light, dark, and system color theme",
  "actions.appearance.setTheme.name": "Set Color Theme…",
  "actions.appearance.setTheme.description": "Set light, dark, or auto color theme",
  "actions.appearance.cycleUiMode.name": "Cycle UI Mode",
  "actions.appearance.cycleUiMode.description":
    "Switch between mouse, touch, and auto UI mode",
  "actions.appearance.setUiMode.name": "Set UI Mode…",
  "actions.appearance.setUiMode.description": "Set mouse, touch, or auto UI mode",
  "actions.appearance.setLocale.name": "Set Language…",
  "actions.appearance.setLocale.description": "Change the display language",
  "actions.selection.toggleMode.name": "Toggle Selection Mode",
  "actions.selectModeToolbar.label": "Selection actions",
  "actions.selectModeToolbar.overflow": "More actions",
  "actions.file.uploadOpenPanel.name": "Open Upload Panel",
  "actions.file.uploadChooseFiles.name": "Choose Files to Upload",
  "actions.connection.category": "Connection",
  "actions.connection.shareUrl.name": "Copy Share URL",
  "actions.connection.switch.name": "Connect to…",
  "actions.connection.create.name": "Create a new connection…",
  ...
  "actions.selection.download.nameWithCount": "Download {{count}} files",
  ...
  "clipboard.cutManyFiles": "Ready to move {{count}} files",
  "clipboard.cutManyFolders": "Ready to move {{count}} folders",
  "clipboard.cutBreakdown": "Ready to move {{files}}, {{folders}}",
  ...
  "connect.name": "Name",
  "connect.namePlaceholder": "Defaults to the bucket name",
  "connect.editTitle": "Edit connection",
  "connect.credentialsTitle": "Enter access keys",
  "connect.credentialsDescription": "Enter the access keys for {{name}}.",
  "connect.rememberKeys": "Remember keys on this device",
  "connect.rememberKeysHint":
    "Keys are saved in this browser's local storage until you forget them. Leave this off to enter them once per session.",
  "connect.save": "Save",
  "connect.cancel": "Cancel",
  "connections.title": "Connect to…",
  "connections.description": "Choose which storage the explorer shows.",
  "connections.browserSubtitle": "Stored in this browser",
  "connections.kernelSubtitle": "Files served by the zfiles CLI",
  ...
  "connections.forgetKeys": "Forget saved keys",
  "connections.delete": "Delete",
  "connections.rowActions": "Connection actions",
  "connections.pillLabel": "Connection: {{name}}",
  "connections.pillTooltip": "Connected to {{name}}. Choose a different connection.",
  "connections.failure.title": "Connection failed",
  "connections.failure.description": "zfiles couldn't reach {{name}}.",
  "connections.failure.retry": "Retry",
  "connections.failure.useDifferent": "Use a different connection",
  "connections.saveConnection": "Save connection",
  "connections.urlConnection": "Shared bucket",
  "connections.urlConnected": "Connected to {{name}} from this link.",
  "connections.unknownSaved": "No saved connection named {{name}}.",
  "connections.switchFailed": "Couldn't connect to {{name}}.",
  "connections.restoreFailed":
    "Couldn't reconnect to {{name}}. Showing browser storage.",
  ...
  "actions.whenFailure.navigationBack": "Nothing to go back to",
  "actions.whenFailure.navigationForward": "Nothing to go forward to",
  "actions.whenFailure.touchUiRequired": "Available in touch UI mode only",
