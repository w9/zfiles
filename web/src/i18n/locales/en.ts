...
export const en = {
  ...
  "shortcuts.hint":
    "Shortcuts: h/j/k/l or arrows navigate (grid); j/k or ↑↓ (table); Enter open, Backspace up, Space slideshow (images), {{shiftClick}}click range, {{commandPalette}} command palette",
